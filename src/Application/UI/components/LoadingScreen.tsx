        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 29/11/2025</p>
                            <p>KB-BIOS (C)2025 Kutraleeswaran B,</p>
                        </div>
                    </div>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Kutraleeswaran Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Kutraleeswaran Portfolio Showcase 2025</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
